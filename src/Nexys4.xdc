...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { test }]; #IO_L18P_T2_A24_15 Sch=led[0]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets input];

set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { input }]; #IO_L20N_T3_A19_15 Sch=ja[1]set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { PIN2 }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
